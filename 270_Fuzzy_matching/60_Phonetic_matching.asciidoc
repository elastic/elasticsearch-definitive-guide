...
representation.((("phonet algorithms"))) The http://en.wikipedia.org/wiki/Soundex[Soundex] algorithm is
...
First, you will need to install ((("Phonetic Analysis plugin")))the Phonetic Analysis plugin from
