...
measures ((("Levenshtein distance")))the number of single character edits which are required to transform
...
later expanded these operations ((("Damerau, Frederick J.")))to include:
