...
*   Entities are _normalized_. The data for a unique entity is stored only
    ...
    an entity only has to happen in one place.((("joins", "in relational databases")))
...
FlatWorld and the real world.((("relationships", "techniques for managing relational data in Elasticsearch"))) There are four common techniques used to manage
