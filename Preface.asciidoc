...
You can find the latest version of this <a href="http://www.elasticsearch.org/guide/">book online</a>.

You can also track the changes that have been made by visiting the <a href="https://github.com/elasticsearch/elasticsearch-definitive-guide/">GitHub repository</a>.
...
the previous one (although you can skim over the chapters just mentioned). Later chapters such as Chapters pass:[<a href="#proximity-matching">15</a>] and pass:[<a href="#partial-matching">16</a>] are more standalone and can be referred to as needed.
