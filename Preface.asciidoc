...
We appreciate, but do not require, attribution. An attribution usually includes the title, author, publisher, and ISBN. For example: ``_Elasticsearch: The Definitive Guide_ by Clinton Gormley and Zachary Tony (O’Reilly). Copyright 2015 Elasticsearch BV, 978-0-596-xxxx-x.''
