...
you-mean_ suggesters. Again, don't worry if you don't know what these terms mean.
 We will also discuss how best to model your data to take
...
it, and what are the trade-offs compared to the alternative solutions? We start with the
...
*  Chapters 1 through 10 provide an introduction to Elasticsearch. They
   ...
   manage indices. By the end of this part you will already be able to
