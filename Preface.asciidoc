...
*  Chapters pass:[<xref linkend="intro" xrefstyle="select: labelnumber"/>] through pass:[<xref linkend="inside-a-shard" xrefstyle="select: labelnumber"/>] provide an introduction to Elasticsearch. They
...
*  Chapters pass:[<xref linkend="_closing_thoughts" xrefstyle="select: labelnumber"/>] through pass:[<xref linkend="geo-aggs" xrefstyle="select: labelnumber"/>] present the two approaches to geolocation
