...
*  Finally, Chapters pass:[<a href="#cluster-admin">45</a>] through pass:[<a href="#post_deploy">47</a>]
...
We appreciate, but do not require, attribution. An attribution usually includes the title, author, publisher, and ISBN. For example: _Elasticsearch: The Definitive Guide_ by Clinton Gormley and Zachary Tony (O’Reilly). Copyright 2015 Elasticsearch BV, 978-1-4493-5854-9.
