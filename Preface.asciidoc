...
*  Chapters pass:[<a data-type="xref" href="#intro">1</a>] through pass:[<a data-type="xref" href="#inside-a-shard">11</a>] provide an introduction to Elasticsearch. They
   ...
   integrate your application with Elasticsearch. Chapters pass:[<a data-type="xref" href="#distributed-cluster">2</a>], pass:[<a data-type="xref" href="#distributed-docs">4</a>], pass:[<a data-type="xref" href="#distributed-search">9</a>], and pass:[<a data-type="xref" href="#inside-a-shard">11</a>] are
   supplemental chapters that provide more insight into the distributed
   processes at work, but are not required reading.

*  Chapters pass:[<a data-type="xref" href="#structured-search">12</a>] through pass:[<a data-type="xref" href="#controlling-relevance">17</a>] offer a deep dive into search--how to index and
...
*  Chapters pass:[<a data-type="xref" href="#language-intro">18</a>] through pass:[<a data-type="xref" href="#fuzzy-matching">23</a>] tackle the thorny subject of dealing with human
...
*  Chapters pass:[<a data-type="xref" href="#_high_level_concepts">24</a>] through pass:[<a data-type="xref" href="#_controlling_memory_use_and_latency">34</a>] discuss aggregations and analytics--ways to
   summarize and group your data to show overall trends.

*  Chapters pass:[<a data-type="xref" href="#_closing_thoughts">35</a>] through pass:[<a data-type="xref" href="#geo-aggs">38</a>] present the two approaches to geolocation
   supported by Elasticsearch: lat/lon geo-points, and complex geo-shapes.

*  Chapters pass:[<a data-type="xref" href="#geo-shapes">39</a>] through pass:[<a data-type="xref" href="#parent-child">42</a>] talk about how to model your data to work
...
*  Finally, Chapters pass:[<a data-type="xref" href="#scale">43</a>] through pass:[<a data-type="xref" href="#cluster-admin">44</a>] discuss moving to production: the important configurations, what to monitor, and how to diagnose and prevent problems.
