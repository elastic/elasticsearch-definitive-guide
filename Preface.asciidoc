...
recognise the warning signs at 3am in the morning in order to prevent
...
it, and what are the tradeoffs of the alternative solutions? We start with the
...
http://www.elasticsearch.org/guide/en/current
