...
-- are very different in nature. ((("social-network activity"))) The number of documents in the index grows
...
Instead, use an _index per-timeframe_. ((("index per-timeframe")))You could start out with an index per
...
Aliases can help to make switching indices more transparent.((("aliases, index")))  For indexing,
