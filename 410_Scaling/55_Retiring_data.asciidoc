...
The nice thing about an index per time frame ((("index per-timeframe", "deleting old data and")))((("indexes", "deleting")))is that it enables us to easily
...
Yesterday's index is unlikely to change.((("indexes", "optimizing")))  Log events are static: what
