...
amount of space in the inverted index.((("indexes", "typical, data contained in")))  That was only partially true.  A
...
The first question you should ((("stopwords", "phrase queries and", "index options")))((("phrase matching", "stopwords and", "index options")))ask yourself is: ``**Do you need phrase or
proximity queries?**''
...
in the index for each field.((("fields", "index options")))  Valid values are:
...
adding new fields using((("put-mapping API"))) the `put-mapping` API. This setting can't be changed
on existing fields:
