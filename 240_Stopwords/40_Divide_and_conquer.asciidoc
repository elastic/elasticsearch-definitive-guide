...
See the http://www.elasticsearch.org/guide/en/elasticsearch/guide/current/common-terms.html#_more_control_with_literal_common_literal_terms[`common` terms query] reference
