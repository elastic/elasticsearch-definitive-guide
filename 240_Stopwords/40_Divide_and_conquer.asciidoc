...
See the https://www.elastic.co/guide/en/elasticsearch/reference/2.x/query-dsl-common-terms-query.html[`common` terms query] reference page for more options.
