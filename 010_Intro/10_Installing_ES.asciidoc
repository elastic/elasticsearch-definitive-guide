...
For newbies, if you are working/accesing ElectricSearch in an external server via telnet o security shell, you will need to substitute "localhost" for the name of your server.
Example: http://myservername.domain:9200/_plugin/marvel/.
