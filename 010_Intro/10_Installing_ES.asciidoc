...
[[sense]]
==== Installing Sense
==== YOU MAY SKIP THIS STEP AS Sense has been renamed Console and is available in Kibana by default in version 5.x. Look under the Dev Tools menu item in the left menu bar.
