...
Marvel is available as a plugin.((("Marvel", "downloading and installing"))) To download and install it, run this command
...
You can reach the *Sense* developer((("Sense", "viewing developer console"))) console either by clicking on the ``Marvel
