...
We happen((("employee directory, building (example)"))) to work for **Megacorp**, and as part of HR's new _"We love our
...
several different meanings in the context of Elasticsearch.((("index, meanings in Elasticsearch"))) A little
