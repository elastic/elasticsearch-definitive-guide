...
.A word about types
**************************************************
In older versions of Elasticsearch, it was possible to create multiple `types`
within one index. In version 6.0+, you may only create one `type` per index.
In version 7.0+, types will no longer be supported.
**************************************************
