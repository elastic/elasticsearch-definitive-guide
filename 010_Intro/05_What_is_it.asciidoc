...
library.((("Apache Lucene")))((("Lucene")))  Lucene is arguably the most advanced, performant and fully-featured
...
``just'' full text search.((("Elasticsearch", "capabilities"))) It is also:
