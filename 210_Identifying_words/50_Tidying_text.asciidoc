...
quotes which *surround* a word should not.((("standard tokenizer", "handling of punctuation")))((("icu_tokenizer", "handling of punctuation")))((("punctuation", "tokenizers&#x27; handling of"))) Tokenizing the text `You're my
'favourite'.` would correctly emit the tokens: `You're`, `my`, `favourite`.

Unfortunately,((("apostrophes"))) Unicode lists a number of characters which are sometimes used
as apostrophes:
...
break up text into tokens.((("quotation marks"))) Unfortunately, some publishers use `U+201B` as a
