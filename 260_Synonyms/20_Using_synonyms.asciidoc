...
Synonyms can replace existing tokens or((("synonyms", "using"))) be added to the token stream using the((("synonym token filter")))
...
synonyms file which must((("synonyms", "specifying inline or in a separate file"))) be present on every node in the cluster. The path to
