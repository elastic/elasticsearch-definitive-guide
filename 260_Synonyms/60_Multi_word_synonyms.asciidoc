...
Multiword synonyms ((("highlighting searches", "multi-word synonyms and")))affect highlighting in a similar way.  A query for `USA`
...
to inject a single((("synonyms", "multi-word, and phrase queries", "using simple contraction")))((("phrase matching", "multi-word synonyms and", "using simple contraction")))((("simple contraction (synonyms)", "using for phrase queries"))) term that represents all synonyms, and to use the same
