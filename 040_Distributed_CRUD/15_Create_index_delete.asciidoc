...
+
--
The default value for ((("replication request parmeter", "sync and async values")))replication is `sync`. ((("sync value, replication parameter")))This causes the primary shard to
