...
This call will _block_ (not return control to your program) until the `cluster-health` has turned green, meaning all primary + replica shards have been allocated.
