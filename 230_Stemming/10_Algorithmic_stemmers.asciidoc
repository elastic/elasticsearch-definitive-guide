...
The http://www.elasticsearch.org/guide/en/elasticsearch/reference/current/analysis-kstem-tokenfilter.html[`kstem` token filter] is a stemmer
...
a new analyzer, with((("english analyzer", "customiing the stemmer"))) the following changes:
