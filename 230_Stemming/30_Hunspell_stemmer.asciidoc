...
analysis-hunspell-tokenfilter.html[`hunspell` token filter].
...
* https://addons.mozilla.org/en-US/thunderbird/language-tools/[_addons.mozilla.org_]:
  Download and unzip the `.xpi` addon file.
* http://archive.services.openoffice.org/pub/mirror/OpenOffice.org/contrib/dictionaries/[OpenOffice archive]: Download and unzip the `.zip` file.
...
documentation site:
http://sourceforge.net/projects/hunspell/files/Hunspell/Documentation/[_sourceforge.net/projects/hunspell/files/Hunspell/Documentation_].
