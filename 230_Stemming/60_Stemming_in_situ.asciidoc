...
http://www.elasticsearch.org/guide/en/elasticsearch/reference/0.90/analysis-keyword-repeat-tokenfilter.html[`keyword_repeat`]
...
http://www.elasticsearch.org/guide/en/elasticsearch/reference/current/analysis-unique-tokenfilter.html[`unique`] token filter((("unique token filter"))) into the mix:
