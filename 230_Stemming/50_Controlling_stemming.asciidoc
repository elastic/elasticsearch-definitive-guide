...
While the language analyzers only allow ((("language analyzers", "stem_exclusion parameter")))us to specify an array of words in the
...
file. ((("keyword_marker token filter", "keyword_path parameter")))The file should contain one word per line, and must be present on every
