...
[[boost-normalization]]
====
The `boost` parameter is used to increase((("boost parameter", "score normalized after boost applied"))) the relative weight of a clause
...
Instead, the new `_score` is _normalized_ after((("normalization", "score normalized after boost applied"))) the boost is applied. Each
