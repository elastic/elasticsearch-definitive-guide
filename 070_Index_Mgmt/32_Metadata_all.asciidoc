...
indexes the ((("metadata, document", "_all field", secondary-sortas="all field")))((("_all field", sortas="all field")))values from all other fields as one big string. The `query_string`
...
If you decide that you no longer ((("_all field", "disabling", sortas="all field")))need the `_all` field, you can disable it
with this mapping:
...
by using the `include_in_all` setting, ((("include_in_all setting")))which defaults to `true`. ((("_all field", "controlling inclusion in", sortas="all field"))) Setting
