...
to update your application to use the new index name.((("index aliases")))  Index _aliases_
to the rescue!
...
Aliases((("aliases", "index"))) give us an enormous amount of flexibility. They allow us:
