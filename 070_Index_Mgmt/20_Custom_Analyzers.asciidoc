...
+
--
An analyzer *must* have a single tokenizer.((("tokenizers", "in analyzers")))  The tokenizer breaks the
...
In the same way as((("index settings", "analysis", "creating custom analyzers")))((("analyzers", "custom, creating"))) we configured the `es_std` analyzer above, we can configure
