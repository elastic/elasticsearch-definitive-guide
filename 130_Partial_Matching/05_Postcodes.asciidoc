...
We will use UK postcodes to illustrate how((("partial matching", "postcodes and structured data"))) to use partial matching with
...
postcode `W1V 3DG` can((("postcodes (UK), partial mapping with"))) be broken down into:
