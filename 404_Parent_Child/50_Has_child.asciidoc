...
potentially match several child documents,((("has_child query"))) each with a different relevance
...
`max_children` parameters,((("min_children parameter")))((("max_children parameter")))((("has_child query"))) which will only return the parent document if the
