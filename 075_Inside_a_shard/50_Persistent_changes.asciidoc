...
image::images/075_50_pre_refresh.png["New documents are added to the in-memory buffer and appended to the transaction log"]
...
image::images/075_50_post_refresh.png["After a refresh, the buffer is cleared but the transaction log is not"]
--
...
image::images/075_50_pre_flush.png["The transaction log keeps accumulating documents"]
...
image::images/075_50_post_flush.png["After a flush, the segments are fully commited and the transaction log is cleared"]
--
