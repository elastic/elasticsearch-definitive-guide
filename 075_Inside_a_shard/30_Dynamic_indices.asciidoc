...
image::images/075_30_index.png["A Lucene index with a commit point and three segments"]
...
image::images/075_30_pre_commit.png["A Lucene index with new documents in the in-memory buffer, ready to commit"]
...
image::images/075_30_post_commit.png["After a commit, a new segment is added to the index and the buffer is cleared"]
