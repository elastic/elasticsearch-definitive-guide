...
filters((("geo_distance_range filter")))((("filtering", "by geo-points", "geo_distance_range filter")))((("ranges", "geo_distance_range filter"))) is that the latter has a doughnut shape and excludes documents within
the central hole.
