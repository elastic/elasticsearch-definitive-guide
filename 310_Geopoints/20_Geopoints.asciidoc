...
documents containing latitude/longitude pairs,((("geo-points", "location fields defined as, lat/lon formats")))((("location field", "defined as geo-point")))((("latitude/longitude pairs", "lat/lon formats for location fields defined as geo-points")))((("arrays", "lat/lon representation for geo-point location fields")))((("strings", "lat/lon representation for geo-point location fields")))((("objects", "lat/lon representation for geo-point location fields"))) which can be formatted as
