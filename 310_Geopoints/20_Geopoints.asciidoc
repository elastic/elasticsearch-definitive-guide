...
documents containing latitude/longitude pairs,((("location field", "defined as geo-point")))((("latitude/longitude pairs", "lat/lon formats for location fields defined as geo-points"))) which can be formatted as
