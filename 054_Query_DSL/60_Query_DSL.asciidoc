...
The ``empty search'' -- `{}` -- is ((("empty search", "equivalent to match_all query clause")))functionally equivalent to using the
...
A query clause typically((("Query DSL", "structure of a query clause"))) has the structure:
...
Query clauses are simple building blocks,((("Query DSL", "combining multiple clauses"))) that can be combined with each
