...
Queries not only have to find((("queries", "performance, filters versus"))) matching documents, but also to calculate how
...
As a general rule, use((("filters", "when to use")))((("queries", "when to use"))) query clauses for *full text* search or
