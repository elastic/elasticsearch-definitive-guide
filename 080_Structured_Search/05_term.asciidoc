...
Internally, Elasticsearch is((("structured search", "finding exact values", "internal filter operations")))((("filters", "internal filter operation"))) performing several operations when executing a
filter:
