...
The `timed_out` value tells((("timed_out value in search results"))) us whether the query timed out or not.  By
default, search requests do not timeout.((("timeout parameter", "specifying in a request")))  If low response times are more
