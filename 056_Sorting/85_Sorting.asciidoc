...
Filtering queries have no bearing on `_score`, and the((("score", seealso="relevance; relevance scores")))
((("match_all query", "score as neutral 1")))((("filtering queries", "score and"))) missing-but-implied `match_all`
