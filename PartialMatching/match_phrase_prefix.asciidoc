...
Analysis happens before the prefix expansion, which means stemmed words are expanded for prefix matching.  If you use an analyzer that stems (like Standard Analyzer), take a moment to verify that you have it setup correctly.  Consider the phrase "the party".
