...
data.((("indexes")))((("clusters", "adding an index")))  In reality, an index is just a ``logical namespace'' which points to
one or more physical _shards_.

A _shard_ is a low-level ``worker unit'' which holds((("shards", "defined"))) just a slice of all the
...
default, indices are assigned 5 primary shards,((("primary shards", "assigned to indexes")))((("replica shards", "assigned to indexes"))) but for the purpose of this
