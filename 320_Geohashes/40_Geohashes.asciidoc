...
`lat/lon` points as strings.((("geohashes")))((("latitude/longitude pairs", "encoding lat/lon points as strings with geohashes")))((("strings", "lat/lon points encoded as, using geohashes")))  The original intention was to have a
