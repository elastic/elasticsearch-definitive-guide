...
about them in the
http://www.elasticsearch.org/guide/en/elasticsearch/guide/current/boosting-by-popularity.html#_literal_modifier_literal[`field_value_factor` documentation].
