...
Javascript.((("Groovy", "script factoring profit margins into relevance calculations"))) The above algorithm as a Groovy script would look like this:
...
The `script_score` function provides enormous flexibility.((("scripting", "performance and")))  Within a script
...
* Use the `rescore` functionality((("rescoring"))) described in <<rescore-api>> to only apply
