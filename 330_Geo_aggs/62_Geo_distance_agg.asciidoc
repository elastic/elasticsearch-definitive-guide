...
The `geo_distance` agg is useful((("geo_distance aggregation")))((("aggregations", "geo_distance"))) for the types of searches where a user wants
...
The response from ((("post filter", "geo_distance aggregation")))the above request is as follows:
...
maximium popularity, etc.((("per_rings aggregation")))
