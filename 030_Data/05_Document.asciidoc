...
// When explaining what is a valid index or type name maybe it should be stated
// that there are more restrictions (https://github.com/elasticsearch/elasticsearch/issues/6736)
// I know this is not the place here to explain the restrictions in details
// but it feels a bit weird to begin explaining what is a valid name and not
// being precise.
