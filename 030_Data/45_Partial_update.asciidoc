...
// As MVEL is going to be replaced by Groovy this makes me think
// that maybe there should be a word somewhere about the
// version of ES this book covers. Maybe a word saying
// that ES evolves really fast, that the content in the book 
// will mostly be relevant for all versions but was written
// for version X.X.X. Maybe also a word explaining that the content
// of the book will be updated regularly to comply with the product evolution.
