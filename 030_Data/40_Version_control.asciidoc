...
image::png/03-01_concurrency.png["Consequence of no concurrency control",width="50%",align="center"]
...
A common setup it to use some other database as the primary datastore and
