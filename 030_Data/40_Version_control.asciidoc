...
When updating a document using ((("conflicts", "dealing with")))the `index` API, we read the original document,
...
used by Elasticsearch, ((("optimistic concurrency control")))assumes that conflicts are unlikely to happen and
