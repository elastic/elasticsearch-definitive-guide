...
price was calculated for each term.((("buckets", "multi-value, sorting", "on deep metrics")))((("metrics", "sorting multi-value buckets by", "deeper, nested metrics")))  It is possible to sort on "deeper" metrics,
