...
price was calculated for each term.((("buckets", "multi-value, sorting", "on deep metrics")))((("metrics", "sorting multi-value buckets by", "deep metrics")))  It is possible to sort on "deeper" metrics,
