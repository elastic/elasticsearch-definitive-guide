...
different nesting schemes.((("aggregations", "buckets", "nested in other buckets")))((("buckets", "nested in other buckets")))  In the previous examples, we saw how you could nest
