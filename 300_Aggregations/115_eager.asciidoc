...
Individual fields((("eager loading", "of global ordinals")))((("global ordinals", "eager"))) can be configured to pre-build global ordinals eagerly:
...
Finally, we come to _index warmers_.  Warmers((("index warmers"))) pre-date eager fielddata loading
