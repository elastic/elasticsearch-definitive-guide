...
histograms must be the second most popular.((("histograms", "building date histograms")))((("aggregations", "building date histograms from")))  Why would you want to use a date
histogram?
...
[[date-histo-ts1]]
image::images/elas_29in01.png["Line chart of cars sold per month"]
...
[[date-histo-ts2]]
image::images/elas_29in02.png["Line chart of cars sold per month"]
...
Due to the real-time nature of aggregations, dashboards like are easy to query,
