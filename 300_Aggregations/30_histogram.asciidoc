...
into charts and graphs.((("bar charts", "building from aggregations")))((("aggregations", "building bar charts from")))  For the rest of the chapter, we are going to focus
...
The `histogram` bucket is particularly useful.((("buckets", "histogram")))((("histogram bucket")))  Histograms are essentially
