...
for those cars,((("filtered query")))((("queries", "filtered"))) we can simply use a `filtered` query:
...
But what if you would like to filter just the aggregation results?((("aggregations", "filtering")))  Imagine we 
