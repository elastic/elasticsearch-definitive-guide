...
_Analysis_ is the ((("analysis", "defined")))process of:
...
This job is ((("analyzers")))performed by _analyzers_. An _analyzer_ is really just a wrapper
which combines three functions into a((("character filters"))) single package:
...
you can use directly.((("analyzers", "built-in"))) We list the most important ones below and, to demonstrate
...
removes, and it is able to _stem_ English ((("stemming words")))words because it understands the
