...
In order to be able to treat date fields as dates, numberic fields as numbers,
...
While the basic field datatypes are sufficient for many cases, you will often
