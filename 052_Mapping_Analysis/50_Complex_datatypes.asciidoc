...
Besides the simple scalar datatypes that we mentioned above,((("data types", "complex core field types")))((("JSON", "datatypes", "complex"))) JSON also
...
_Inner fields_ can be referred to by((("inner fields"))) name, eg `"first"`. To distinguish
