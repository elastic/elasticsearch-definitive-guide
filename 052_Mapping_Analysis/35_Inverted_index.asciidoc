...
Elasticsearch uses a structure called((("inverted index"))) an _inverted index_ which is designed
...
If we apply a naive _similarity algorithm_ which((("similarity algorithm"))) just counts the number of
